...
\cvpubitem{Searching under the streetlight for useful software analytics}
          {P. Johnson}
          {IEEE Software}
          {Volume 30, No. 4, July 2013}

\cvpubitem{Operational definition and automated inference of test-driven development with Zorro}
          {H. Kou, P. Johnson, H. Erdogmus}
          {Automated Software Engineering}
          {Volume 16, Number 4, December 2009}

\cvpubitem{Protocols in the use of Empirical Software Engineering Artifacts}
          {V. Basili, M. Zelkowitz, D. Sjoberg, P. Johnson, T. Cowling}
          {Empirical Software Engineering}
          {Volume 12, February 2007}

\cvpubitem{Experiments to understand HPC time to development}
          {L. Hochstein, T. Nakamura, V. Basili, S. Asgari, M. Zelkowitz, J. Hollingsworth, F. Shull, J. Carver, M. Voelp, N. Zazworka, P. Johnson}
          {CTWatch Quarterly}
          {November 2006}

\cvpubitem{Improving software development management through software project telemetry}
          {P. Johnson, H.~Kou, M.~Paulding, Q.~Zhang, A.~Kagawa, T.~Yamashita}
          {IEEE Software}
          {Volume 22, No. 4, July 2005}

\cvpubitem{Measuring {HPC} Productivity}
          {S.~Faulk, J.~Gustafson, P.~Johnson, A.~Porter, W.~Tichy, L.~Votta}
          {International Journal of High Performance Computing Applications}
          {December 2004}

\cvpubitem{Lessons learned from VCommerce: A virtual environment for interdisciplinary learning about software entrepreneurship}
          {P.~Johnson, M.~Moffett, B.~Pentland}
          {Communications of the ACM}
          {Volume 46, No. 12, December 2003}

\cvpubitem{Empirically guided software effort guesstimation}
          {P.~Johnson, C.~Moore, J.~Dane, R.~Brewer}
          {IEEE Software}
          {Volume 17, No. 6, December 2000}

\cvpubitem{A critical analysis of PSP data quality: Results from a case study}
          {P.~Johnson, A.~Disney}
...
\cvpubitem{Energy feedback for smart grid consumers: Lessons learned from the Kukui Cup}
          {R. Brewer, Y. Xu, G. Lee, M. Katchuck, C. Moore, P. Johnson}
          {Proceedings of Energy 2013}
          {Lisbon, Portugal, March 2013}

\cvpubitem{Makahiki+WattDepot: An open source software stack for next generation energy research and education}
...
\cvpubitem{Beyond kWh: Myths and fixes for energy competition game design}
          {P. Johnson, Y. Xu, R. Brewer, G. Lee, M. Katchuck, C. Moore}
          {Proceedings of Meaningful Play 2012}
          {Lansing, Michigan, October 2012}

\cvpubitem{The Kukui Cup: A dorm energy competition focused on sustainable behavior change and energy literacy}
...
\cvpubitem{WattDepot: An open source software ecosystem for enterprise-scale energy data collection, storage, analysis, and visualization}
...
\cvpubitem{We need more coverage, stat! Experiences with the Software ICU}
...
\cvpubitem{Requirement and design trade-offs in Hackystat: An in-process software engineering measurement and analysis system}
          {P. Johnson}
...
\cvpubitem{Automated recognition of test-driven development with Zorro}
          {P. Johnson and H. Kou}
          {Proceedings of Agile 2007}
          {Washington, D.C., August 2007}

\cvpubitem{Practical automated process and product metric collection and analysis in a classroom setting: {L}essons learned from {Hackystat-UH}}
...
\cvpubitem{Beyond the Personal Software Process: Metrics collection and analysis for the differently disciplined}
...
\cvpubitem{Leap: A ``Personal Information Environment'' for software engineers}
          {P.~Johnson}
          {Proceedings of the 1999 International Conference on Software Engineering}
          {Los Angeles, CA., May 1999}

\cvpubitem{Investigating data quality problems in the PSP}
          {A.~Disney, P.~Johnson}
          {Proceedings of the Sixth International Symposium on the Foundations of Software Engineering}
          {Orlando, FL., November 1998}

\cvpubitem{Assessing software review meetings: A controlled experimental study using CSRS}
          {P.~Johnson, D.~Tjahjono}
...
\cvpubitem{Lights Off. Game On. The Kukui Cup: A dorm energy competition}
          {R. Brewer, G. Lee, Y. Xu, C. Desiato, M. Katchuck, P. Johnson}
          {Proceedings of the 2011 CHI Workshop on Gamification}
          {May 2011}

\cvpubitem{Ultra-automation and ultra-autonomy for software engineering management of ultra-large-scale systems}
          {P. Johnson}
          {Proceedings of the 2007 Workshop on Ultra Large Scale Systems}
          {Minneapolis, Minnesota, May 2007}

\cvpubitem{Automated recognition of low-level process: A pilot validation study of Zorro for test-driven development}
          {H. Kou, P.~Johnson}
          {Proceedings of the 2006 International Workshop on Software Process}
          {Shanghai, China, May 2006}

\cvpubitem{Understanding HPC Development through automated process and product measurement with Hackystat}
          {P.~Johnson, M.~Paulding}
          {Proceedings of the Second Workshop on Productivity and Performance in High-End Computing}
          {February 2005}

\cvpubitem{You can't even ask them to push a button: Toward ubiquitous, developer-centric, empirical software engineering}
          {P.~Johnson}
...
\cvitem{Program Committee Member}{Energy 2011, 2012, 2013}

\cvitem{Program Co-Chair}{First International Workshop on In-Process
Software Engineering Measurement and Analysis, Montreal, Canada, October, 2007}

\cvitem{Program Committee}{Third International Workshop on Software
Engineering for High Performance Computing System Applications, 
Minneapolis, MN,  May, 2007}

\cvitem {Editorial Board}{Journal of Empirical Software Engineering, 2004-2008}

\cvitem {Program Committee Member}{PROFES 2005-2010}

\cvitem {Program Committee Member}{Workshop on Productivity and
Performance in High-End Computing, 2005-2006}

\cvitem {Program Chair}{Second International Workshop on Software
Engineering for High Performance Computing System Applications, St. Louis,
MO, May, 2005}

\cvitem {Program Chair}{First International Workshop on Software
Engineering for High Performance Computing System Applications, Edinburgh,
Scotland, May, 2004}

\cvitem {Program Committee Member}{XP/Agile Universe,  Calgary, CA, August 2004}

\cvitem {Program Committee Member}{International Software Metrics Symposium, 2003-2004} 

\cvitem {Program Committee Member}{International Symposium on Empirical Software Engineering, 2002-2004}

\cvitem {Editorial Board}{IEEE Transactions on Software Engineering, 2000-2004}

\cvitem {Program Chair}{International Software Engineering Research Network Annual Meeting, Honolulu, HI, 2000}

\cvitem {Member}{State of Hawaii Millenium Workforce Development Initiative, 1999}
...
\cvitem {Founder and Chair}{
  Hawaii Java Users Group,
  Honolulu, Hawaii, 1996-present}

\cvitem {Member}{International Software Engineering Research Network
(ISERN), 1996-present} 
