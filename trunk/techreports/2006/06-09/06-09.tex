...
\title{EVALUATION OF JUPITER:\\A LIGHTWEIGHT CODE REVIEW FRAMEWORK}
...
%% last.
\othermembers{Daniel Suthers\\Martha Crosby}
...
\include{06-09-acknowledgements}

%%% Bring in the abstract section from external file
\include{06-09-abstract}
