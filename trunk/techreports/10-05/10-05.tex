...
%% Last Modified On: Tue Apr 13 18:09:38 2010
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
WattDepot is not intended for these more rigorous requirements.  We intend
WattDepot to provide a mechanism to accelerate innovative research and
development into energy analysis and visualization at the community level
by providing an extensible architecture and well documented, open source
software platform.
