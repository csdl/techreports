...
%% Last Modified On: Sat Feb 28 11:46:49 2009
%% RCS: $Id$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Copyright (C) 2009 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
using Hackystat.  In 2003, we performed a case study in which we used an
early version of Hackystat to automate data collection and analysis and
used a survey to assess student reactions \cite{csdl2-03-12}.  (We
found...) We performed a partial replication of this study in 2006 with a
redesigned version of Hackystat \cite{csdl2-07-02}.  (We found...)

A general result of our prior work is that understanding how to make
measurements actionable is very difficult for students.  This led us to the
idea of the medical ICU as an orienting metaphor for measurement use, and
the implementation of an equivalent technology support, as discussed in the
next section.
