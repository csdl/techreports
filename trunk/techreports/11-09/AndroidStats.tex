...
year Android platform was selected for the challenge. Two XML files containing change and bug report data 
were offered to participants to uncover interesting facts related to the Android platform.

\section{Data processing and auxiliary information collection.}
...
tracking system. The XSD for both XML files can be found in the Appendix section of this report:
\ref{changeXSD}, \ref{bugsXSD}.
