...
\section{Results}
This section presents the responses from the respondents to each of the questions. For the "short answer" questions, I corrected misspellings and minor grammatical errors to improve readability. Questions are sorted with the selection questions first in the following table and then the short answer questions follow. 
