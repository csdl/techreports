...
\documentclass[11pt,draft,thesis,proposal]{uhthesis2e}
...
\title{Kukui Cup: A Competition for Encouraging Energy Literacy}
...
\include{keokilee-ms-thesis-dedication}

%%% Bring in the acknowledgments section from external file
\include{keokilee-ms-thesis-acknowledgments}

%%% Bring in the abstract section from external file
\include{keokilee-ms-thesis-abstract}
...
\include{keokilee-ms-thesis-body}

%%% Bring in any appendices from external file
\include{keokilee-ms-thesis-appendix}

%%% Input file for bibliography
\bibliography{csdl-trs,psp,keokilee-ms-thesis}
