...
Symbolic Aggregate approXimation was proposed by Lin et al in \cite{citeulike:2821475}. This method extends PAA-based approach inheriting algorithm simplicity and low computational complexity while provide satisfiable sensitivity and selectivity in range-query processing. Moreover, the use of a symbolic representation opens the door to the existing wealth of data-structures and string-manipulation algorithms in computer science such as hashing, regular expression pattern matching, suffix trees etc.
