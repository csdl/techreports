...
\end{align}
The scale and shift transformations discussed along with smoothening and matching envelope discussed in greater details in the section \ref{scales_and_shifts}.
