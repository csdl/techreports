...
\begin{abstract}
Similarity search in the time-series databases become an active research area in the past decade corresponding to the tremendous growth of the amount of the temporal data collected and publicly available. The complexity of the problem lies in the high dimensionality of the temporal data which is making convenient methods to fail. The most promising aproaches involve the dimensionality reduction and indexing techniques wich are the subject of this review. While starting with general introduction into the time-series and classical time-series analyses we will discuss the time-series normalization techniques and relevant distance metrics following with the review of the evolution of the dimensionality-reduction and indexing techniques up to date.
\end{abstract}
