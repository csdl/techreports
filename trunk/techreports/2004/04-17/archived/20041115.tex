...
to pass a set of milestone tests, each of which is a unit of
...
time.  Finally, the performance of the application will bechronologically
recorded.  All of these processes will be collected as telemetry data.

In order to accomplish the objectives of this research, a two part
thesis is proposed:
\begin{enumerate}
  \item The paradigm for characterizing HPCS developmented can be
  implemented in a software system that automatically gathers metrics
  for milestone tests, degree of parallelism in source code and
  application performance.
  \item Use of this software system is effective for HPCS developers
  and project managers to understand and characterize their
  development process in academic and industry settings.
\end{enumerate}
