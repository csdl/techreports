...
training \cite{citeulike:10358271, citeulike:532340, citeulike:11796594, citeulike:12563424}. 
...
classifier built upon Euclidean distance \cite{citeulike:4214336} or SpADe \cite{citeulike:12563361}. 
...
Examples from this category include classifier based on Discrete Fourier Transform \cite{citeulike:5094223}
and a classifier based on Bag-Of-Patterns representation (BOP) \cite{citeulike:10525778}. 
...
often pre-processed time series data \cite{citeulike:532340}, 
they usually fail on long and noisy data sets \cite{citeulike:12563380},
...
%large unprocessed data much more efficiently \cite{paa, sax, citeulike:532335}.
...
identification and interpretability \cite{citeulike:11957982}.
...
longest time series),
which makes difficult its adoption for many-class classification problems \cite{citeulike:11345338}. 
While a better solution was recently proposed ($O(nm^{2})$), it is an approximate 
algorithm, that is based on iSAX approximation and indexing \cite{citeulike:12563493}.
...
Symbolic Aggregate approXimation \cite{citeulike:2821475}, which is a high-level symbolic  representation 
...
(DIRECT) algorithm that does not require any parameters \cite{citeulike:12563460}. DIRECT is a derivative-free
