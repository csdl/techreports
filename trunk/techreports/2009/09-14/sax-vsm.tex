...
Further in this Chapter I shall review the current state of the art in TSC, propose a novel algorithm for \textit{interpretable} 
time series classification, evaluate its classification performance as well as its  capacity to provide interpretable results, 
...
The NN classifier is simple, accurate and robust, depends on a very few parameters 
