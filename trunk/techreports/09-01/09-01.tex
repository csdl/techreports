...
%% Last Modified On: Tue Jan 13 17:44:26 2009
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
statements, methods, and/or test case assertions).  We have implemented a
Hackystat sensor for the Eclipse IDE to collect these events for the Java
language, and a Hackystat sensor for the Visual Studio IDE to collect these
events for the C# language.
