...
The independent variable in this experiment is {\em group interaction},
...
%The ICS-411 defect type classification is detailed in Section
%\ref{app:defect-classes}.
...
For either review method, the typical procedure for using CSRS 
...
\begin{figure}[htpb]
 {\centerline{\psfig{figure=jese97-main-hyp2.eps}}}
...
\bigskip
{\bf Keywords: } Formal technical review, inspection, experimental study, CSRS.
