...
\mbox{similarity}(\boldsymbol{a},\boldsymbol{b}) = cos(\theta) =  
...
\cite{logical} classifier and the shapelet transform classifier \cite{bagnal}. We use this 
particular subset of known data sets, because it contains performance metrics for all four
classifiers. The performance of SAX-VSM for the rest of data sets can be found online along with 
...
series. Intuitively, if some of the class representative terms will be lost, the cosine
...
In Proc of the 23rd international conference on Machine learning (ICML '06), 1033--1040 (2006)

%3
\bibitem {spade}
Chen, Y., Nascimento, M. A., Ooi, B. C., Tung, A. K. H.:
Spade: On shape-based pattern detection in streaming time series. 
In Proc. of the IEEE 23rd International Conference on Data Engineering, 786--795 (2007)

%4
\bibitem {DFT}
Agrawal, R., Faloutsos, C., Swami, A.:
Efficient Similarity Search In Sequence Databases.
In Proc. FODO '93, 69--84 (1993)
...
In Proc. ACM KDD 2002, 102--111 (2002)

%7
\bibitem {indexing}
Keogh, E.:
Exact indexing of dynamic time warping. 
In Proc of the 28th international conference on Very Large Data Bases (VLDB '02), 406--417 (2002)
...
In Proc 18th ACM SIGKDD KDD '12, 289--297 (2012)
...
In Proc CP '95. 137--153 (1995)

%20
\bibitem {motifs}
Chiu.B, Keogh, E., Lonardi, S.:
Probabilistic discovery of time series motifs. 
In Proc. of  9th ACM SIGKDD (KDD '03) (2003)

%21
\bibitem {streaming_sax}
Lin, J., Keogh, E., Lonardi, S., Chiu, B.:
A symbolic representation of time series, with implications for streaming algorithms. 
In Proc 8th ACM SIGMOD workshop DMKD '03. 2-11, (2003)
...
Master thesis, Oregon State University (2002)
...
In Proc. 4 Intl Conference on KDD, 9--15 (1998)
