...
%
\titlerunning{Timeseries features discovery with SAX and TF-IDF weighting}  % abbreviated title (for
running head)
...
divicategorized in two major categories. The first category of classification techniques is based on
...
\cite{DFT}, or SpAD e\cite{spade}
a PLA shapelet tree \cite{shapelet}.
...
problems difficult. 
\todo{Sergey, - cant figure out the way to convince the reader that 1NN and shapelets are the
state of the art}
