...
class. 
However, instead of iterative search for these (as in shapelets case), our algorithm finds and weights by
...
algorithm, which was introduced by Jones et al. \cite{direct-original}.
...
synthetic datasets. Further, we evaluated our technique on the long time series
originating from PhysioNet archive \cite{physionet}. 
...
Secondly, while DIRECT optimization provides satisfiable performance, it is designed for a 
