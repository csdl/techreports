...
that our approach consistently delivers .... \cite{kmetrics}

While we have not yet conducted a further experimental evaluation study, previously, we 
applied our implementation to recurrent behaviors (motifs) discovery in software development 
telemetry streams\cite{android}. 
...
We have used the bag of words 
time series representation and spherical k-Means clustering in order to discover specific 
temporal features corresponding to the software release cycle. 
