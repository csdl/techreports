...
the differences in coffee flavor. The highlighted spectrogram features align with previously
reported findings \cite{coffee}.
...
originating from PhysioNet archive \cite{physionet}. We extracted two hundreds fifty series
corresponding to five vital signals: two ECG leads, and RESP, PLETH, and CO2 waves,
