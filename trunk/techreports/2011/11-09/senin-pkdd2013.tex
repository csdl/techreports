...
\textit{tf$\ast$idf} ranking scheme, SAX-VSM allows users to discriminate time series
subsequences by their class characterization power.

\section{Future directions}
The current limitations of our implementation suggest a number of future work directions. 

Vector Space model naturally supports processing of bags of words which have multiple word lengths
in the same
classifier, our implementation lacks this capacity. Certainly this is a major limitation since
shapelet-based techniques \cite{bagnal} not only provide such a feature
