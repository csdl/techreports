...
particular problem by the choice of distance measure, 
...
Thus, a demand for a simple, efficient, and interpretable technique capable of processing
...
The performance of SAX-VSM for the rest of the data sets \textit{will be made online
 along with our reference implementation if accepted}.
%\cite{jmotif}.
...
accounted 23'569 value (Fig. \ref{fig:venn}, right). In our opinion, this result reflects two
...
\begin{figure}[t]
  ...
  (left panel; the noise level varies up to 100\% of signal value,
...
\begin{figure}[t]
   ...
   another dictionary - we subtracted its weight.}
   \label{fig:heat}
\end{figure}
