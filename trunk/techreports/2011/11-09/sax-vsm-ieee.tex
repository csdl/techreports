...
\begin{abstract}
%\boldmath
n this paper, we propose a novel method for characteristic patterns discovery in 
...
\cite{review, benchmark, comparison, classifiers}. Nevertheless, while possessing all these
qualities,
...
\begin{figure}[t]
   ...
   \centering
   \includegraphics[width=88mm]{figures/precision-runtime.eps}
...
\begin{figure}[t]
  \myfigureshrinkerless
  \centering
  \includegraphics[width=88mm]{figures/corrupted.eps}
