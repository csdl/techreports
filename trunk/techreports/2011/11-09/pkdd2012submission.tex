...
Git is used as a version control system for Android and the source code is organized 
...
\begin{table*}
  \caption{Patterns observed within pre- and post-release windows, their $TF\ast IDF$ weights and sample curves.}
  \label{tab:tokens}
