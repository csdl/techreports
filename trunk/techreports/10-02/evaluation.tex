...
% It would be good to dig a little deeper here.  In addition to looking at "events", it would be better to think about what you would do with this data.  For example, it will probably be useful to categorize users as "low", "moderate", or "high" users of the site.  Similar categories could be used for participation in goals, activities, and commitments.

\fxnote{talk about what to do with log data, here or in profile section}
