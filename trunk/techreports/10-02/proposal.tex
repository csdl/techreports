...
\title{Motivating Energy Conservation In Dormitories Using Real-Time Feedback and Social Marketing}
...
%\include{proposal-vision}
\include{proposal-research-questions}
%\include{proposal-system-description}
%\include{proposal-experiment}
%\include{proposal-plan}
%\include{proposal-conclusion}

%%% Bring in any appendices from external file
%\include{proposal-appendix}
