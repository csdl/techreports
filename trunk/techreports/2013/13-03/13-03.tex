...
The interview took place after the challenge. We
asked him about his game management experiences using the Makahiki admin
interface, as outlined in the game manager section of the SGSEEM.
We analyzed the qualitative data collected from the interview. In addition,
The admin interface log data was also analyzed to assess if there were any errors
