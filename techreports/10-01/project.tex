...
%% Last Modified On: Wed Jan  6 13:39:53 2010
%% RCS: $Id$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Copyright (C) 2009 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{floatingfigure}[l]{3.25in}
  \center
  \includegraphics[width=0.5\textwidth]{fig.luciddesigngroup.eps}
...
\begin{figure*}[th]
  \center
  \includegraphics[width=0.8\textwidth]{fig.architecture.eps}
...
%  \includegraphics[width=0.5\textwidth]{fig.greenometer.eps}
...
% Figure \ref{fig:espheres} illustrates the subsumption
% hierarchy for this example.

% \begin{floatingfigure}[l]{3.25in}
%  \center
%   \includegraphics[width=0.5\textwidth]{fig.espheres.eps}
...
Figure \ref{fig:esphere-mockup} illustrates one page from a user interface mockup that
...
\begin{figure*}[th]
  \center
  \includegraphics[width=0.8\textwidth]{fig.esphere-mockup.eps}
...
\begin{figure*}[th]
  \center
  \includegraphics[width=0.8\textwidth]{fig.gantt.eps}
