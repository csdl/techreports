...
sub printUsage() {
  ...
  print("     updateBertha  - [Bertha]  Copy necessary files to Bertha.\n");
  print("\n");
}
...
sub doUpdateBertha() {
  print("[Scp files to bertha]\n");
  $cmd1='scp build.pl *.tex  qzhang@bertha.ics.hawaii.edu:/export/home/csdl/techreports/04-16';
  $cmd2='scp figures/*.eps   qzhang@bertha.ics.hawaii.edu:/export/home/csdl/techreports/04-16/figures';
  $cmd3='scp reference/*.bib qzhang@bertha.ics.hawaii.edu:/export/home/csdl/techreports/04-16/reference';
