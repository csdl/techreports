...
%% Last Modified On: Sat Mar 07 10:20:15 2009
%% RCS: $Id$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Copyright (C) 2009 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
overhead to be substantial \cite{csdl2-01-12}. The Software ICU provides
...
positive response included {\em ``All group projects in all schools
(e.g. Architecture) should be required to use such a system.''}  On the
other hand, the most negative response included {\em ``Actually hackystat
(or hacky-stalk as what my teammates and I called it) caused a lot of
arguments and trash talk.  Some guys were more concerned about collecting
stats on Hackystat than actually finishing the project.''}
...
Several of the replies focussed on how it could be useful as a management
tool: {\em ``I think its good to have this in a professional environment,
...
workers.''} Another write, {\em ``I could see project managers wanting to
