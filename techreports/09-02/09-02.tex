...
%% Last Modified On: Fri Mar 06 19:03:48 2009
%% RCS: $Id$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Copyright (C) 2009 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{\em Overhead of installation and use.}
...
Subversion.  Overhead of use was mixed: one response was ``The sensors ran
automatically and it was fast with sending the data,'' while another was
``Sending sensor data was often quite slow.''  
...
students ``how did you feel about sharing your software development data
with other members of the class.''  Fifteen out of eighteen responses were
generally positive about this aspect, with comments such as, ``I had no
problem with this, and it encouraged me to be aware of my time management
and coding style''. One student responded, ``Did not really like it because
it is showing my programming habits, like starting on a project in the last
couple of days.''  The most positive response included, ``All group
projects in all schools (e.g. Architecture) should be required to use such
a system.'' On the other hand, the most negative response included
``Actually hackystat (or hacky-stalk as what my teammates and I called it)
caused a lot of arguments and trash talk.  Some guys were more concerned
about collecting stats on Hackystat than actually finishing the project.''
...
One of our central research questions was the effectiveness of our
...
the responses revealed insight into the limitations of metrics, such as ``I
felt most of the colors accurately represented the health of the
...
a problem of Hackystat.''  Another respondent wrote: ``The ICU was accurate
with our project because it showed drastic spikes in all signs.  This
reflects our project in poor health.''  One of the negative responses wrote
how pursuing high coverage as an end in itself could be a waste of time,
that DevTime does not measure the time spent reading a book, and that
complexity and coupling are hard to evaluate.
