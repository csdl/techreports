...
performance, shapelets-based techniques are quite time-consuming, which makes their
adoption for many class classification problems difficult \cite{bagnal}. 
