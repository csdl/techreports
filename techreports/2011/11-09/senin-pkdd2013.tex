...
it into a string of a defined length $w$ ($w << n$) where letters are taken from an alphabet $\alpha$
($|\alpha|=A$). 
...
This table is built by defining a set of breakpoints that divide the normalized time series distribution 
