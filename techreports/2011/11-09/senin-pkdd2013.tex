...
%
\title{Timeseries features discovery with SAX and TFIDF weighting}
%
\titlerunning{Timeseries features discovery with SAX and TFIDF weighting}  % abbreviated title (for running head)
...
\begin{abstract}
Ability to discover characteristic features in timeseries 
paves the road for their classification and enables 
interpretability of results.

In this paper, I propose a novel method for timeseries features 
discovery based on three existing techniques - 
Symbolic Aggeregate Approximation (SAX), TFIDF weighting, and Vector space model. 
This method is not only capable of discovering and ranking features 
by their ``importance'' - which yields higher classification accuracy -
but facilitates interpretability of the final model. 

While being computationally intensive in the training phase, this method is 
faster, and more accurate than current state-of-the art classifiers during
classification.
