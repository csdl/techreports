...
This weighting scheme naturally improves the selectivity of classification by  lowering the
contribution of ``confusive'' multi-class terms, and  increasing  the contribution  of  class'
``defining'' terms to the final cosine value.
...
\begin{figure}[tbp]
   \centering
   \includegraphics[width=125mm]{figures/figure_direct.eps}
   \caption{Illustration of parameters optimization with DIRECT algorithm. Left panel shows
all points sampled by DIRECT in the space $Window*PAA*Alphabet$. Middle panel shows the heatmap
colored according to error rate when the sliding window size is fixed to 42, this figure was
obtained by complete scan of 432 points. Right panel shows the optimized by DIRECT sampling, optimal
solution was found by sampling of 43 points. }
