...
our technique performs well on noisy data, moreover SAX-VSM learns efficiently from 
...
algorithms, notably fast shapelets \cite{fast-shapelets} - which utilize the dimensionality
reduction and the low-bounding property for significant performance improvement.
...
As we mentioned, each of the extracted with sliding window subsequences is 
