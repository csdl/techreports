...
%% Last Modified On: Fri Apr 17 15:07:05 2009
%% RCS: $Id$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Copyright (C) 2009 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Demographics & What are the required or desirable characteristics of the
...
initiative: demographics, empiricism, abstraction, automation, learning
outcomes, and outcome data.  The structure of this framework, and the
questions we pursue within each area, are based upon our prior \eCT\
experiences starting with the PSP and up to our current evaluation of the
Software ICU.
...
around the unifying concept of empirical computational thinking.  This
community will be created and maintained through electronic infrastructure,
such as community repositories for technology, curriculum materials, and
data.  It will also be maintained through joint research and teaching
activities.
...
create interesting new opportunites for meta-analysis and data mining.  
