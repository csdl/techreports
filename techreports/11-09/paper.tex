...
\section{Conclusions}
The presented approach and workflow employs two novel techniques in order
to discover and rank recurrent behaviors from software process artifact trails. 
Its application to Android OS kernel-OMAP sub-project artifact trail yielded 
valid pre- and post-release behavior models. 
