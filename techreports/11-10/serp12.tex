...
afected by the choice software process \cite{citeulike:9919804}. Thus, studying 
...
These empirical studies usually involve 
interviewing and monitoring of developers, both are expensive, and often limited in 
scale techniques. Furthermore, within open-source projects with a diverse 
development community scattered over the globe, these techniques are virtually 
impossible to apply. Fortunately, current advances in software configuration 
...
Mining of large software repositories demand advanced techniques 
allowing to tame with the complexities associated with data extraction and analysis.
