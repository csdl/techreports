...
%% Last Modified On: Sat Jan 29 15:58:16 2000
%% RCS: $Id: budget.tex,v 1.1 2000/01/31 22:12:48 rbrewer Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[htb]
  ...
  \end{center}
\end{table}
% LocalWords:  tex http com routingPage html htb Exp colocated StartX SP
