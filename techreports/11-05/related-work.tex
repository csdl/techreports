...
A Serious game is a game designed for a primary purpose other than pure entertainment (Wikipedia). It include games that make use of computer technology and advanced video graphics and that are used for the purposes of learning and training.
Its category includes educational games and advergames, political games, and training game (also known as game-learning).

One excellent example is Fold.it, 
...
In other words, if you have no choice in the matter, it’s not a game.
