...
%% Last Modified On: Thu Jan 15 10:08:35 2009
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The following sections summarize the three validation studies we performed;
...
classified, for an accuracy rate of 89\%.  Analysis of the differences
between Zorro inferences and the ESR data analyses indicated that some
editing work and test case invocations were not captured correctly by
Zorro.  These fixes were made prior to the second case study.
...
{\bf Results.}  First, due to a bug in the data collection mechanism, we
lost some data from one participant, which reduced the number of subjects
whose data we analyzed from 11 to 10.
