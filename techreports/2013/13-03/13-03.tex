...
%\numberofauthors{4}
%\author{
%  \alignauthor Yongwen Xu, Carleton A. Moore, Robert S. Brewer, Philip M. Johnson\\
%    \affaddr{Department of Information and Computer Sciences}\\
%    \affaddr{University of Hawaii at Manoa}\\
%    \affaddr{Honolulu, HI, USA}\\
%    \email{\{yxu, cmoore, rbrewer, johnson\}@hawaii.edu}\\
%}
...
%% PJ: Provide a KC home page screen shot here.
...
%\emph{How efficient is it to design a game using the serious game framework?}
...
%\emph{How efficient is it to manage the game using the serious game  framework?}
