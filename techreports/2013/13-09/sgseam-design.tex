...
\autoref{table:assessment-report} shows a template for the improvement action report.
\begin{table}[ht!]
  \centering
  \begin{tabular}{|p{0.18\columnwidth}|P{0.2\columnwidth}|P{0.2\columnwidth}|P{0.3\columnwidth}|}
    ...
    \hline
  \end{tabular}
  \caption{SGSEAM Improvement Action Report}
  \label{table:assesment-report}
\end{table}
...
\begin{table}[ht!]
  ...
  \begin{tabular}{|P{0.17\columnwidth}|P{0.39\columnwidth}|P{0.18\columnwidth}|P{0.14\columnwidth}|}
    \hline
    \multicolumn{2}{|c|}{\tabhead{Task}} &
    \tabhead{Outcomes} &
    \tabhead{Deliverables} \\
    \hline
    \multirow{3}{0.18\columnwidth}{Step 1: Plan assessment} & 1a) Identify stakeholder participants & participant list & 
    \multirow{3}{0.15\columnwidth}{Assessment plan document} \\
    \cline{2-3}
     & 1b) Determine stakeholder approaches & approaches and goals & \\
     \cline{2-3}
     & 1c) Create schedule & schedule & \\
    \hline
    \multirow{3}{0.18\columnwidth}{Step 2: Gather data} & 2a) Carry out assessments & responses and game data & 
    \multirow{3}{0.15\columnwidth}{Data repository} \\    
    \cline{2-3}
     & 2b) Obtain log data & game log & \\
    \hline
    \multirow{3}{0.18\columnwidth}{Step 3: Produce report} & 3a) Analyze data & analysis results & 
    \multirow{3}{0.15\columnwidth}{Improvement actions document} \\    
    \cline{2-3}
