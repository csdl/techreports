...
\begin{table}[ht!]
  ...
  \begin{tabular}{|P{0.27\columnwidth}|p{0.42\columnwidth}|P{0.21\columnwidth}|}
    ...
    Heroku client \\
    \hline
    2.1 (Optional) Configure SSL & install webserver, enable SSL & addons:add ssl \\
    \hline
