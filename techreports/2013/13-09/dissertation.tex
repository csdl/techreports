...
%\documentclass[oneside,12pt,dissertation]{uhthesis2e}
...
\usepackage[colorlinks, linkcolor=blue, urlcolor=blue, citecolor=blue, bookmarks=true]{hyperref}
...
backgroundcolor=gray!20,shadow=true,shadowsize=3]{shadebox}
...
\include{makahiki-design}
\include{sgseam-design}
\include{evaluation}
\include{results}
\include{conclusion}
...
\include{appendix-sgseam-makahiki-plan}
\include{appendix-sgseam-makahiki-data}
\include{appendix-sgseam-makahiki-report}
\include{appendix-sgseam-lucid-guide}
\include{appendix-ingame-survey}
\include{appendix-lab-study-googleform}
