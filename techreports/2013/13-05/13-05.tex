...
\title{Three Design Principles for the Design of \\ Energy Feedback Visualizations}
...
\begin{figure}[!tb]
	\centering
	\includegraphics[width=\columnwidth]{energy-24hours-new.eps}
...
\begin{figure}[!tb]
	\centering
	\includegraphics[width=\columnwidth]{power-meter.eps}
...
\begin{figure}[!tb]
	\centering
	\includegraphics[width=\columnwidth]{how-meet-goal.eps}
