...
% draft mode.
%
%% Not clear what is the best formatting for IARIA journal publications.
%% For now, using old IEEEtran class file, with same parameters as was used
%% for the ENERGY conference. This will generate a warning when running LaTeX,
%% since the class file name differs from the class being offered.
\documentclass[10pt, conference, compsocconf]{IEEEtran-old}
...
\hypersetup{
pdftitle={Three Principles for the Design of Energy Feedback Visualizations},
pdfauthor={Robert S. Brewer, Yongwen Xu, George E. Lee, Michelle Katchuck, Carleton A. Moore, and Philip M. Johnson},
pdfkeywords={visualization} {serious games} {energy feedback} {energy} {energy literacy} {smart grid},
bookmarksnumbered,
pdfstartview={FitH},
colorlinks,
citecolor=black,
...
\title{Three Principles for the Design of Energy Feedback Visualizations}

% author names and affiliations
% use a multiple column layout for up to two different
% affiliations

\author{\IEEEauthorblockN{Robert S. Brewer, Yongwen Xu, George E. Lee, Michelle Katchuck, Carleton A. Moore, and Philip M. Johnson}
...
% mention that lotteries increase charitable giving?
% http://home.uchicago.edu/jlist/research2/charitable.html
...
%% To allow custom hacking of the bib entries to meet IARIA style
%% requirements, this is .bib that has only the entries cited in this
%% document by examining the aux file. It was generated with the
%% "bibexport" script, which thankfully ships as part of TeXLive. This
%% command line generates the file:
%%   bibexport -o 13-05.bib 13-05.aux
%% Unfortunately, bibexport will line wrap the value of "url" fields, which
%% causes the links generated in the PDF to not work. Simply unwrap those
%% lines to repair the damage. Reported to author markey@lsv.ens-cachan.fr
%% in Jan 2013, no reply.
%%
%% The manual hacking required is to remove URL fields from entries where it
%% might look strange in the bibliography (like a journal article), and to
%% add notes about last retrieval time to digital items like web pages. I
%% did this by adding "note =          {[retrieved: January, 2013]}," to the
%% bib entries.
\bibliography{13-05}
% Bib files the citations are drawn from, when not using hacked bib
