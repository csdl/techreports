...
When using telemetry, Member Devtime, Member Commit and Member Build are the major analyses that students paid attention on. More than half of the students said they were trying to find out the member devtime of themselves and/or their groupmates. They may partially because the major component they were using was Software ICU and the member level analyses are only found in Telemetry. However, from the vital sign popularity we consider this as another evidence that the students paid lots of attention on DevTime and Commit statistics.
