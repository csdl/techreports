...
experienced during sensor installation and server conﬁgura- 
tion, as well as any suggestions you have to make this easier 
in future.
\begin{itemize}
...
The data indicates that eclipse sensor was easy to install. Ant sensors were little more difficult to install. The most difficult one is the SVN sensor. 
...
First, in 2007, the Hackystat system underwent a complete rewritten for a new version: Hackystat v8. Hackystat v8 now is organized as a collection of loosely coupled software services that communicate using REST architectural principles. 
...
The empirical data indicates that the installation difficulties of both Eclipse sensor and Ant sensors increased in 2008, especially the Ant sensors.
...
\end{longtable}
\end{center}
It is surprise that the overhead of use increase dramatically in 2008. As reported in short-answers questions, the overhead is mainly contributed by the running time of collecting data and generating analyses.
...
The data indicates that student feelings toward ``professional feasibility'' increased since 2006 and was the highest among the three evaluations.
