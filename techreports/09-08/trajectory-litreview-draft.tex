...
\begin{abstract}
The document walks through existing techniques for time-series indexing and similarity search approaches found in the literature up to date. Some of the topics are DFT, DWT ... will be adding more here. 
\end{abstract}
...
%% similarity measures
\include{general_similarity}
\include{euclidean_distance}
