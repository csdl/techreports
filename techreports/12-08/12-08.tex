...
\acknowledgements{The Kukui Cup is supported in part by grant IIS-1017126 from the
  ...
  Caterina Desiato, Risa Khamsi, Alex Young, and Chris Zorn.}
...
made significant progress toward it within the Kukui Cup.   But we believe that 
any consideration of macro behavioral change within the design of the competition improves
the potential impact of the event. 

\subsection{Fix \#5: Do challenges, not competitions}


\subsection{Fix \#8: The meaningful data comes after it's over}



\subsection{Fix \#6: Do science; be skeptical}

In most of the energy competitions that we reviewed, we were struck by the lack of rigor
with which data and analyses were performed and the uncritical reception provided to
claims regarding energy reductions and cost savings.  It is a situation in which well
intentioned people (volunteer students, usually) put tremendous time and effort into an
activity with clearly positive social outcomes.  Although everyone (ourselves included)
wants a positive, successful outcome, progress in this field depends upon a thoughtful,
critical analysis of how the competitions are designed and what we can say with confidence
about the outcomes.  It is in this spirit that we have written this paper so that future
energy competition designers can push forward 




Search for causal factors, look at outliers. For example, in data presented on the Cal
