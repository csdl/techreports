...
%% Last Modified On: Thu Mar 22 13:39:32 2007
%% RCS: $Id$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%\usepackage{graphicx} %% New LaTeX2e graphics support
...
\include{07-04-introduction}
\include{07-04-related}
\include{07-04-framework}
\include{07-04-implementation}
\include{07-04-research-evaluation}
\include{07-04-casestudy-pilot}
\include{07-04-casestudy-classroom}
\include{07-04-casestudy-industry}
\include{07-04-conclusion}
\include{07-04-appendix}

\bibliography{bib/csdl-trs,bib/psp,bib/tdd,bib/zorro,bib/hackystat}
