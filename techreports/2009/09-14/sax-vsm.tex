...
As I have shown in previous chapters, despite the fact that public software repositories offer large amount of software 
artifacts and diverse information for the scientific research, their intrinsic complexity and immaturity of currently 
available techniques \cite{citeulike:7853299} \cite{citeulike:12550438}, which lack automation and efficiency, 
limit the breadth and the scope of current MSR research.

Addressing this problem, I propose a novel, automated and efficient approach for mining of software repositories 
that specifically concerned with the discovery of recurrent behaviors - basic building blocks of software processes. 
The proposed approach builds upon the hypothesis that it is possible to discover recurrent behaviors by the analysis of 
``software trajectories'' which are the sequences of temporally ordered software artifact measurements. 
While the idea and the background which led to this hypothesis are thoroughly discussed in the previous chapters, 
here I propose a technique which provides means for the hypothesis investigation. 
For this, I turn to another research field, which is traditionally concerned with sequential data.
...
range of fields, including data mining, image and motion recognition, environmental sciences, health care, and chemometrics. 
Approaches discussed and developed within this field are concerned with finding ways to identify class-characteristic 
features. 

Within the last decade, many time series representations, similarity measures, and classification algorithms 
were proposed following the rapid progress in data collection and storage technologies \cite{citeulike:10358271}. 
