...
Time series classification is a well-established and increasingly popular area of the research providing solutions to a wide 
...
shapelet and a full time series, defined as a distance between the shapelet and the closest subsequence in the time series 
...
represented by the pattern occurrence frequency vectors. As the authors has shown, these can be classified with NN classifier built with 
...
In another series of experiments, I have replaced up to 50\% of an unlabeled time series span with a randomly placed 
