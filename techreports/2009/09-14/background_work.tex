...
\fxnote{do I need to iterate over SAX-VSM and baseline establishment through comparative analyses?}
...
The decision to use public software repositories in the second exploratory study was made in order to increase its 
...
%Mining software repositories is not a new research direction and much work has been done previously, but only few attempts 
%were made targeting discovery of recurrent behaviors from software artifacts.
