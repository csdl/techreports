...
discussed later in Chapter \ref{chapter_results}, consider the example shown at the Figure \ref{fig:STA2-results} 
...
Based on these and other results, I have designed the STA DB in an extensible metadata-centric manner. 
